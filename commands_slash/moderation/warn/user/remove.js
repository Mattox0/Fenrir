        ...
        db.get("SELECT * FROM warns WHERE warn_id = ?",id, async (err, res) => {
            if (err || !res) {
                const fail = new MessageEmbed()
                    .setColor('#2f3136')
                    .setDescription('<a:LMT__arrow:831817537388937277> **Je ne trouve pas la référence de ce warn**')
                    ...
                    switch (collected.first().customId) {
                        case 'Oui':
                            ...
                            const win = new MessageEmbed()
                                .setColor('#2f3136')
                                .setDescription(`<a:LMT__arrow:831817537388937277> **Le warn \`${id}\` a bien été supprimé !**`)
                                .setFooter({text:`LMT-Bot ・ Aujourd'hui à ${date.toLocaleTimeString().slice(0,-3)}`, iconURL:'https://cdn.discordapp.com/avatars/784943061616427018/2dd6a7254954046ce7aa31c42f1147e4.webp'})
