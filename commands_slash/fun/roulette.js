...
module.exports = {
    ...
    async execute(...params) {
        ...
        let date = params[2];
        const ask = new MessageActionRow()
            .addComponents(
                new MessageButton()
        ...
        .setColor('#2f3136')
        .setDescription(`<a:LMT__arrow:831817537388937277> **Appuyez sur le bouton pour participer à la roulette !**`)
        ...
        interaction.editReply({embeds:[debut],components: [ask]}).then(async msg => {
                ...
                switch (collected.customId) {
                    case 'Participe':
                        ...
                        const delai = new MessageEmbed()
                            .setColor('#2f3136')
                            .setDescription(`<a:LMT__arrow:831817537388937277> **${collected.user} participe !**\n[${tab.length} participants]\n**Participants** :\n${participants}`)
                            .setFooter({text:`LMT-Bot ・ Aujourd'hui à ${date.toLocaleTimeString().slice(0,-3)}`, iconURL:'https://cdn.discordapp.com/avatars/784943061616427018/2dd6a7254954046ce7aa31c42f1147e4.webp'})
            ...
            collector.on("end",async collected => {
                if (tab.length >= 2) {
                    for (let i = 3;i > 0;i--) {
                        const attente = new MessageEmbed()
                            .setColor('#2f3136')
                            .setDescription(`<a:LMT__arrow:831817537388937277> Le tirage commence dans ${i}`)
                            .setFooter({text:`LMT-Bot ・ Aujourd'hui à ${date.toLocaleTimeString().slice(0,-3)}`, iconURL:'https://cdn.discordapp.com/avatars/784943061616427018/2dd6a7254954046ce7aa31c42f1147e4.webp'})
                    ...
                    const fail = new MessageEmbed()
                        .setColor('#2f3136')
                        .setDescription('<a:LMT__arrow:831817537388937277> **Il faut être au moins 2 pour jouer !**')
                        .setFooter({text:`LMT-Bot ・ Aujourd'hui à ${date.toLocaleTimeString().slice(0,-3)}`, iconURL:'https://cdn.discordapp.com/avatars/784943061616427018/2dd6a7254954046ce7aa31c42f1147e4.webp'})
