...
module.exports = {
    ...
    async execute(...params) {
        ...
        let link = `https://some-random-api.ml/canvas/pixelate/?avatar=${person.user.displayAvatarURL({ format: 'png' })}`;
        let attachment = new MessageAttachment(link, 'pixelate.gif');
