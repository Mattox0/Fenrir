...
module.exports = {
    async execute(client, db) {
        db.each("SELECT guild_id, stats_id, stats_bot_id, stats_online_id, stats_message, stats_bot_message, stats_online_message FROM servers", async (err, res) => {
            if (err) {return console.log("STATS", err)}
