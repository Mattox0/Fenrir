...
module.exports = {
	...
	execute(...params) {
        ...
        let db = params[1];
        let date = new Date()
        db.get("SELECT inviteCreate, logs_id FROM logs WHERE guild_id = ?",invite.guild.id, async (err, res) => {
