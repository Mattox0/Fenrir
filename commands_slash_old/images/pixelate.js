...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('pixelate')
        .setDescription('Pixelise la photo de profil de soi ou d\'un utilisateur')
    ...
    async execute(...params) {
        ...
        let link = `https://some-random-api.ml/canvas/pixelate/?avatar=${person.user.displayAvatarURL({ extension: 'png' })}`;
        let attachment = new AttachmentBuilder(link, { name:'pixelate.png' });  
        const embed = new EmbedBuilder()
            .setColor('#2f3136')
            .setImage('attachment://pixelate.gif')
            .setFooter({text:`LMT-Bot ・ Aujourd'hui à ${date.toLocaleTimeString().slice(0,-3)}`, iconURL:'https://cdn.discordapp.com/avatars/784943061616427018/2dd6a7254954046ce7aa31c42f1147e4.webp'})
